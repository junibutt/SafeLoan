...
const LoanModal = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl w-[90%] max-w-xl p-4 sm:p-6 shadow-xl overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex justify-between mt-6">
              ...
              <button
                ...
                className={`px-4 py-2 rounded ${
                  form.agreed ? "bg-green-600 text-white" : "bg-gray-300 text-gray-600"
                }`}
              >
                Submit
              </button>
